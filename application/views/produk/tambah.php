...
<body>
  ...
  <div class="container">
    <div class="card mt-5">
      ...
      <div class="card-body">
        <form action="<?= base_url('produk/tambah_data')?>" method="post">
          <div class="mb-3">
            <label for="nama-produk" class="form-label">Nama Produk</label>
            <input type="text" name="name" class="form-control" id="nama-produk" value="<?=set_value('name')?>">
            <?=form_error('name', '<small class="text-danger pl-3">', '</small>');?>
          </div>
          <div class="mb-3">
            <label for="harga-produk" class="form-label">Harga</label>
            <input type="text" name="harga" class="form-control" id="harga-produk" value="<?=set_value('harga')?>">
